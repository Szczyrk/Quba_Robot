...
Const Granicalinii = 600                                    'te wartosc zmieniamy tak, zeby czujniki wykrywaly linie
Const Makspredkosc = 150                                    'maksymalna wartosc PWM z zakresu 0-255 (silniki Pololu ruszaja od ok. 140)
...
Pwm1b = 0                                                   'silnik lewy (patrzac na tyl robota) - wypelnienie PWM
   ...
   Do
      ...
      While Przycisk > 0                                    'wykonuje petle programu dopoki znow nie wcisniemy przycisku
         ...
         ElseIf Linia3 > Granicalinii Then
                  Gosub Skretprawo
                     Wait 100
         ...
         Elseif Linia4 > Granicalinii Then
                Gosub Skretlewo
                             Wait 100
...
Skretprawo:
   ...
   Set Mset2a : Reset Mset2b
   Pwm1a = 0
   Pwm1b = Minpredkosc - 10
Return

Skretlewo:
   Set Mset1a : Reset Mset1b
   Set Mset2a : Reset Mset2b
   Pwm1a = Minpredkosc - 10
   Pwm1b = 0
Return